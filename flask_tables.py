...
headings2_x = ('Excluded Core Number', 'Peak_Split_All_Projection_X')
headings2_y = ('Excluded Core Number', 'Peak_Split_All_Projection_Y')
headings3_x = ('Corestack Core Number', 'Peak_Split_Corestack_Projection_X')
headings3_y = ('Corestack Core Number', 'Peak_Split_Corestack_Projection_Y')
headings4_x = ('NewClump Core Number', 'Peak_Split_NewClump_Projection_X')
headings4_y = ('NewClump Core Number', 'Peak_Split_NewClump_Projection_Y')
headings5_x = ('Orig Core Number', 'Peak_Split_Orig_Projection_X')
headings5_y = ('Orig Core Number', 'Peak_Split_Orig_Projection_Y')
...
data4= tuple(zip(u301_peak_split_proj_x_list,u301_peak_split_proj_y_list,excluded_core_list_x,excluded_core_list_y))
data5 = tuple(zip(u301_peak_split_corestack_x_list, u301_peak_split_corestack_y_list, corestack_list_x, corestack_list_y))
data6 =tuple(zip(u301_peak_split_newclump_x_list,u301_peak_split_newclump_y_list,newclump_list_x, newclump_list_y))
data7 = tuple(zip(u301_peak_split_orig_x_list,u301_peak_split_orig_y_list,orignum_list_x,orignum_list_y))
